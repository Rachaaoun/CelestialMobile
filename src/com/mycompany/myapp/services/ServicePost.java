         ...
         req.addResponseListener(new ActionListener<NetworkEvent>() {
            ...
            public void actionPerformed(NetworkEvent evt) {
                ...
                try {
                    ...
                    List<Map<String, Object>> listOfMaps = (List<Map<String, Object>>) mapReclamations.get("post");
                   System.out.println("lissst"+mapReclamations);
                    for(Map<String, Object> obj : listOfMaps) {
                        Post re = new Post();

                        String nom = obj.get("nom").toString();
                        String imgPost =obj.get("imgPost").toString();
                          String descriptionPost =obj.get("descriptionPost").toString();
                            
                              
                              float id = Float.parseFloat(obj.get("id").toString());
                     re.setId((int)id);
                     re.setNom(nom);
                     re.setDescription_post(descriptionPost);
                     re.setImg_post(imgPost);
                     result.add(re);
