...
//        super.addSideMenu(res);
  ...
  public void sendMail(Resources res,Post p) {
		...
		props.put("mail.smtps.auth", "true"); //enable authentication
            ...
            msg.setFrom(new InternetAddress("Un commentaire a été ajouté <monEmail@domaine.com>"));
            msg.setRecipients(Message.RecipientType.TO, "racha.aoun@hotmail.com");
            msg.setSubject("Commentaire ajouté ");
            msg.setSentDate(new Date(System.currentTimeMillis()));
            
           //String mp = ServiceUtilisateur.getInstance().getPasswordByEmail(email.getText().toString(), res);//mp taw narj3lo
           String txt = "Un nouveau commentaire a été ajouté au post "+ p.getNom();
